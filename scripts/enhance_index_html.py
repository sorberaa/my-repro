...
.brand {{ font-size:14px; font-weight:800; color:#fff; display:flex; align-items:center; gap:8px; text-transform:uppercase; letter-spacing:0.5px; cursor:pointer; }}
...
// ВЫВОД РЕЗУЛЬТАТОВ РАЗВЕДКИ (GITHUB, CRYPTO, SHERLOCK, PHONE, DOMAIN, IP, CLI)
